...
- unpack [BepInExConfigManager.Il2Cpp](https://github.com/Jelosus2/BepInExConfigManager) plugin to `..\BepInEx\` folder
...
## Used libraries
- [BepInEx/BepInEx.IL2CPP](https://nuget.bepinex.dev/packages/BepInEx.IL2CPP) - v6.0.0-be.755
